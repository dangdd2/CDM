...
namespace Tmag.ConsumerData.Migrations
{
    ...
    [Migration("20180328213518_addeddeletetoconsumer")]
    partial class addeddeletetoconsumer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tmag.ConsumerData.Models.ConsumerOptIn", b =>
                {
                    ...
                    b.HasIndex("ConsumerProfileId", "Key")
                        .IsUnique()
            ...
            modelBuilder.Entity("Tmag.ConsumerData.Models.Gender", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("gender_id");
            ...
            modelBuilder.Entity("Tmag.ConsumerData.Models.Model", b =>
                {
                    ...
                    b.Property<string>("ImageReg")
                        .HasColumnName("image_reg")
                        .HasMaxLength(2000);
            ...
            modelBuilder.Entity("Tmag.ConsumerData.Models.Consumer", b =>
                {
                    b.HasOne("Tmag.ConsumerData.Models.Gender", "GenderLookUp")
                        .WithMany()
            ...
            modelBuilder.Entity("Tmag.ConsumerData.Models.ConsumerOptIn", b =>
                {
                    b.HasOne("Tmag.ConsumerData.Models.ConsumerProfile")
