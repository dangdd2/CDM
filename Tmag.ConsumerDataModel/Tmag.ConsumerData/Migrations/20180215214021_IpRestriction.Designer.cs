...
namespace Tmag.ConsumerData.Migrations
{
    ...
    [Migration("20180215214021_IpRestriction")]
    partial class IpRestriction
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tmag.ConsumerData.Models.ClubShaftLength", b =>
                {
                    ...
                    b.Property<bool>("is_minor_adjustment")
            ...
            modelBuilder.Entity("Tmag.ConsumerData.Models.ConsumerOptIn", b =>
                {
                    ...
                    b.Property<Guid?>("ConsumerEmailId");
            ...
            modelBuilder.Entity("Tmag.ConsumerData.Models.ConsumerOptIn", b =>
                {
                    b.HasOne("Tmag.ConsumerData.Models.ConsumerEmail", "ConsumerEmail")
                        .WithMany("ConsumerOptIns")
                        .HasForeignKey("ConsumerEmailId");
                });
